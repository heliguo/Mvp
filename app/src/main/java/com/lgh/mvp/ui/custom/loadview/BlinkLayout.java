package com.lgh.mvp.ui.custom.loadview;
...
public class BlinkLayout extends LinearLayout {
    ...
    public BlinkLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        try {
            ...
            shimmerColor = a.getColor(R.styleable.BlinkLayout_blink_color, ContextCompat.getColor(context, R.color.colorPrimaryDark));
        } finally {
            a.recycle();
        }
    }
